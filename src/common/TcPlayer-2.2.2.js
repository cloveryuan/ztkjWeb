module.exports = !function(e, t) {
    ...
    return function(e) {
        ...
        function a(e, t) {
            ...
            d.IS_X5TBS && e.x5_player ? w.mobile = ["flv", "m3u8", "mp4"] : d.IS_ENABLED_MSE && e.h5_flv && (w.mobile = ["flv", "m3u8", "mp4"])) : (e.flash = !!t.isFormat("rtmp") || e.flash,
            t.isFormat("flv") && void 0 == e.flash && (e.flash = !0),
            e.flash ? d.IS_ENABLED_FLASH || (e.flash = !1,
            d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : w.pc = ["mp4"]) : d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : d.IS_ENABLED_FLASH ? e.flash = !0 : w.pc = ["mp4"]),
            e.clarity) {
    ...
    , function(e, t, i) {
        ...
        function c(e, t) {
            ...
            "webkitbeginfullscreen" == e.type ? (b.on(t.video.el, "webkitendfullscreen", function(e) {
                c(e, t)
            }),
            _.pub({
                type: g.MSG.FullScreen,
            ...
            }, p.player)) : "webkitendfullscreen" == e.type && (b.off(t.video.el, "webkitendfullscreen", c),
            _.pub({
                type: g.MSG.FullScreen,
                src: "util",
                ts: e.timeStamp,
        ...
        function p(e, t, i) {
            ...
            p.player = e,
            E.requestFullscreen ? t ? (b.on(document, E.fullscreenchange, l),
            i && i[E.requestFullscreen]()) : document[E.exitFullscreen]() : o && e.video.el.webkitEnterFullScreen ? (b.on(e.video.el, "webkitbeginfullscreen", function(t) {
                c(t, e)
            }),
            ...
            b.on(document, "keydown", u)) : (document.documentElement.style.overflow = p.__origOverflow,
            b.off(document, "keydown", u)),
            b.toggleClass(document.body, "vcp-full-window", t),
            _.pub({
                type: g.MSG.FullScreen,
                src: "util",
                detail: {
        ...
        t.escapeHTML = y,
        t.getFormat = v;
        for (var m = i(2), b = o(m), g = i(4), _ = o(g), w = i(1), S = (o(w),
        1), E = t.FullscreenApi = {
    ...
    , function(e, t, i) {
        ...
        t.Player = function() {
            function e(t) {
                ...
                i = F.get(i),
                this.mtaReport = new T["default"](this,this.options),
                void this.render(i)) : console.error("Player need a container")
            }
            return e.prototype.render = function(e) {
                var t = "vcp-player";
                if (L.TOUCH_ENABLED && (t += " touchable"),
                this.el = F.createEl("div", {
                    "class": t
                }),
                e.appendChild(this.el),
                this.errortips = new P["default"](this),
                this.errortips.render(this.el),
                this.loading = new O["default"](this),
                ...
                (L.IS_SAFARI && parseInt(L.SAFARI_VERSION) > 10 || L.IOS_VERSION > 10) && "system" == this.options.controls || (this.bigplay = new w["default"](this),
          ...
          , w = function(e) {
            ...
            t.prototype.load = function(e, t) {
                ...
                if (!g.IS_ENABLED_MSE || !i && !o || g.IS_X5TBS && this.player.options.x5_player || i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS)
                    ...
                    "undefined" == typeof window.Hls ? h.loadScript(f.CDNPath + r, function() {
                        n.__hlsLoaded.call(n, e)
                    }) : this.__hlsLoaded(e)) : o && (this.__type = f.VideoType.FLV,
                    "undefined" == typeof window.flvjs ? h.loadScript(f.CDNPath + "libs/flv.min.js", function() {
    ...
    , function(e, t, i) {
        ...
        var c = i(11)
          ...
          , _ = function(e) {
            ...
            t.prototype.notify = function(e, t) {
                ...
                try {
                    ...
                    case "playState":
                        ...
                        t.playState == m.PlayStates.PLAYING ? (this.__playing = !0,
                        this.__stopped = !1,
                        i.type = p.MSG.Play) : t.playState == m.PlayStates.PAUSED ? (this.__playing = !1,
                        this.__stopped = !1,
                        i.type = p.MSG.Pause) : t.playState == m.PlayStates.STOP ? (this.__playing = !1,
                        this.__stopped = !0,
                        i.type = p.MSG.Ended,
                        this.__prevPlayState = null,
                        this.options.live && (this.metaDataLoaded = !1)) : t.playState == m.PlayStates.IDLE && (this.__playing = !1,
                        this.__stopped = !0,
                        i.type = p.MSG.Ended);
                        break;
                    case "seekState":
                        ...
                        if (t.seekState == m.SeekStates.SEEKING)
                            ...
                            if (t.seekState != m.SeekStates.SEEKED)
                                return;
                            this.__m3u8 || this.options.live || t.playState != m.PlayStates.STOP || (this.play(),
                            this.__prevPlayState = t.playState),
                            this.__m3u8 && (i.type = p.MSG.Seeked)
                        }
                        break;
                    case "netStatus":
                        this.options.live || ("NetStream.Buffer.Full" == t.code ? (this.__prevPlayState == m.PlayStates.PAUSED || this.__prevPlayState == m.PlayStates.STOP,
                        this.__prevPlayState = null,
                        i.type = p.MSG.Seeked) : "NetStream.Seek.Complete" == t.code),
                        "NetConnection.Connect.Closed" == t.code && (this.options.src.indexOf("rtmp://") > -1 ? this.playState == m.PlayStates.STOP ? (i.type = "error",
                        t = {
                            code: 13,
                            reason: t.code
                        }) : (i.type = "error",
            ...
            ,
            t.prototype.togglePlay = function() {
                this.metaDataLoaded ? this.playState == m.PlayStates.PAUSED ? this.el.playerResume() : this.playState == m.PlayStates.PLAYING ? this.el.playerPause() : this.playState == m.PlayStates.STOP ? (this.currentTime(0),
        ...
        var l = i(11)
          ...
          , C = function(e) {
            ...
            t.prototype.render = function(t) {
                ...
                T.IS_MOBILE || (this.volume = new _["default"](this.player),
                this.volume.render(this.el)),
                this.options.videoSource && this.options.videoSource.definitions.length > 1 && !T.IS_MOBILE && (this.claritySwitcher = new S["default"](this.player),
            ...
            t.prototype.show = function() {
                O.hasClass(this.el, "hide") && (O.removeClass(this.el, "hide"),
                O.addClass(this.el, "show"))
            }
            ,
